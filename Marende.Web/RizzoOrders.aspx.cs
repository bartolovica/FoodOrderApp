...
{
    public partial class RizzoOrders : System.Web.UI.Page
    {
        ...
        protected void okRizzoButton_Click(object sender, EventArgs e)
        {
        ...
        private DTO.OrderDto buildOrder()
        {
            ...
            order.TunaPasteta = tunaPastetaCheckBox.Checked;
            order.TunaKomdai = tunaKomadiCheckBox.Checked;
